...
/usr/lib/jvm/java-10-openjdk-amd64/bin/javac \
	...
	src/main/java/ws/nzen/jarl/parser/ConfigParser.java src/main/java/ws/nzen/jarl/parser/FastArgParser.java src/main/java/ws/nzen/jarl/parser/ParserFactory.java src/main/java/ws/nzen/jarl/parser/XmlBasedParser.java \
	src/main/java/ws/nzen/jarl/ui/CliSelection.java src/main/java/ws/nzen/jarl/ui/SelectionUi.java

/usr/lib/jvm/java-10-openjdk-amd64/bin/jar --create --file=mlib/ws.nzen.jarl@0.0.jar --module-version=1.0 -C mods/ws.nzen.jarl .
